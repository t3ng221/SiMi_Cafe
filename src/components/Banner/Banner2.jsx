...
import BgImg from "../../assets/website/coffee-texture2.jpg";
...
const Banner2 = () => {
  return (
    <>
      <span id="about"></span>
      <div style={bgImage}>
        <div className="min-h-[550px] flex justify-center items-center py-12 sm:py-0 ml-20 ">
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Caffè americano Boost Productivity
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-500 tracking-wide leading-5"
                >
                  Caffè americano also known as americano or American, is a type
                  of coffee drink prepared by diluting an espresso shot with hot
                  water at a 1:3 to 1:4 ratio
                </p>
